            ...
            <div className="container">
                {
                    loader ? <div className="loader-container">
                        ...
                        <div className="row mt-2 viewProductMain">
                            ...
                            <div className="col-md-6 justify-content-center">
                                ...
                                <p className=""><s className='text-muted'>₹{data.price}</s> ₹{data.price - data.discount} <span className='text-success'>{parseInt((data.discount / data.price) * 100)}% off</span></p>
