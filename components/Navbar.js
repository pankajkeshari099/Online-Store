...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top" style={{position: 'relative'}}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link to='/about' className='nav-link'><i className="fa-sharp fa-solid fa-circle-info"></i> About</Link>
                        </li>
